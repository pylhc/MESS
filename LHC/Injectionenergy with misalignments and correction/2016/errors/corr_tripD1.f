...
ccccc Version: 23 Sept. 2008
	       ...
	       if(INDEX(charaux,"MQX").ne.0) then
	        if(INDEX(charaux,"MQXA.1").ne.0) then
	        itot=itot+1
	        imag=1
		scale=scaleMQX
	        elseif(INDEX(charaux,"MQXB.A").ne.0) then
	        itot=itot+1
	        imag=2
	        scale=scaleMQX
	        elseif(INDEX(charaux,"MQXB.B").ne.0) then
	        itot=itot+1
	        imag=3
	        scale=scaleMQX
	        elseif(INDEX(charaux,"MQXA.3").ne.0) then
	        itot=itot+1
	        imag=4
	        scale=scaleMQX
	        endif
...
c	       enddo
	       ...
	       write(6,*) 
               ...
               if(itot.ne.248) then
	write(6,*) itot
	write(6,*) "Something wrong optics file optics0_inser.mad"
	write(6,*) "or number of slices not equal to 4 in MQX, D1 or D2"
	        endif
...
c	       enddo
               ...
               if(itot.ne.200) then
	       write(6,*) 
     +         "Warning some MQX, D1 or D2 errors are not defined"
               endif
...
C  A2 correction (local left /local right)
     ...
     +         'KQSX3.L1 :=',a2cor(1),'/l.MQSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KQSX3.R1 :=',a2cor(2),'/l.MQSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KQSX3.L2 :=',a2cor(3),'/l.MQSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KQSX3.R2 :=',a2cor(4),'/l.MQSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KQSX3.L5 :=',a2cor(5),'/l.MQSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KQSX3.R5 :=',a2cor(6),'/l.MQSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
...
C  A3 correction (left / right cancellation of (0,3),(3,0) in 1/2/5 and 8)
	       ...
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSSX3.L1 :=',bv*a3cor(1),'/l.MCSSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSSX3.R1 :=',bv*a3cor(2),'/l.MCSSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSSX3.L2 :=',bv*a3cor(3),'/l.MCSSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSSX3.R2 :=',bv*a3cor(4),'/l.MCSSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSSX3.L5 :=',bv*a3cor(5),'/l.MCSSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSSX3.R5 :=',bv*a3cor(6),'/l.MCSSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
...
C  A4 correction (left / right cancellation of (1,3),(3,1) in 1/2/5 and 8)
	       ...
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOSX3.L1 :=',a4cor(1),'/l.MCOSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOSX3.R1 :=',a4cor(2),'/l.MCOSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOSX3.L2 :=',a4cor(3),'/l.MCOSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOSX3.R2 :=',a4cor(4),'/l.MCOSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOSX3.L5 :=',a4cor(5),'/l.MCOSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOSX3.R5 :=',a4cor(6),'/l.MCOSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
...
C  B4 correction (left / right cancellation of (0,4),(4,0) in 1/2/5 and 8)
	       ...
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOX3.L1 :=',bv*b4cor(1),'/l.MCOX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOX3.R1 :=',bv*b4cor(2),'/l.MCOX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOX3.L2 :=',bv*b4cor(3),'/l.MCOX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOX3.R2 :=',bv*b4cor(4),'/l.MCOX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOX3.L5 :=',bv*b4cor(5),'/l.MCOX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCOX3.R5 :=',bv*b4cor(6),'/l.MCOX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
...
c	       enddo
	       ...
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSX3.L1 :=',b3cor(1),'/l.MCSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSX3.R1 :=',b3cor(2),'/l.MCSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSX3.L2 :=',b3cor(3),'/l.MCSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSX3.R2 :=',b3cor(4),'/l.MCSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSX3.L5 :=',b3cor(5),'/l.MCSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCSX3.R5 :=',b3cor(6),'/l.MCSX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
...
C  (6,0),(0,6))
	       ...
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCTX3.L1 :=',bv*b6cor(1),'/l.MCTX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCTX3.R1 :=',bv*b6cor(2),'/l.MCTX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCTX3.L2 :=',bv*b6cor(3),'/l.MCTX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCTX3.R2 :=',bv*b6cor(4),'/l.MCTX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCTX3.L5 :=',bv*b6cor(5),'/l.MCTX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
     +         'KCTX3.R5 :=',bv*b6cor(6),'/l.MCTX ;'
	       write(1,'(a12,1x,e14.6,1x,a10)')
